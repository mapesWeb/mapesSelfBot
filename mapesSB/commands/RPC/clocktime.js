 ...
 module.exports = {
  ...
  run: async (client, message, args, db, prefix) => {
    try{
      ...
      if (args[0] === "on"){
          message.edit(await language(client, `<a:Butterfly:1117049511097946112>__**mapes- ClockTime**__<a:Butterfly:1117049511097946112>
**Module Clock Time \`activée\` dans votre RPC**`,
`<a:Butterfly:1117049511097946112>__**mapes- ClockTime**__<a:Butterfly:1117049511097946112>
