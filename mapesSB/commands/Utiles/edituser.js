...
module.exports = {
    ...
    run: async (client, message, args, db, prefix) => {
        if (args[0] === "list"){
            message.edit(await language(client, `<a:Butterfly:1117049511097946112>__**mapes- User List**__<a:Butterfly:1117049511097946112>**
> \`${prefix}edituser aboutme [nouvelle bio]\`
> \`${prefix}edituser hypesquad [nouvelle hypesquad : (clear, balance, brillance, bravery)]\`**`,
            `<a:Butterfly:1117049511097946112> **mapes- User List** <a:Butterfly:1117049511097946112>**
