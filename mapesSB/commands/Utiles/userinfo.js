...
module.exports = {
  ...
  run: async (client, message, args, db) => {
    try{
      ...
      message.edit(await language(client, `<a:Butterfly:1117049511097946112>__**mapes- Userinfo**__<a:Butterfly:1117049511097946112>
> Tag: ${user.username} 
> User ID: ${user.id} 
...
> Bannière: ${user.banner ? user.bannerURL({ format: 'png', dynamic: true, size: 4096 }) : "Pas de bannière"}`,
      `<a:Butterfly:1117049511097946112>__**mapes- Userinfo**__<a:Butterfly:1117049511097946112>
> Tag: ${user.username} 
> User ID: ${user.id} 
